...
public class PassportAdapter extends RecyclerView.Adapter<PassportAdapter.PhotoViewHolder> {
    private Context context;
    private List<Bitmap> photoList;
    private OnRemoveClickListener onRemoveClickListener;

    public PassportAdapter(Context context, List<Bitmap> photoList, OnRemoveClickListener onRemoveClickListener) {
