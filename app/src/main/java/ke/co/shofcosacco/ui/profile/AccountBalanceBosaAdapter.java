...
public class AccountBalanceBosaAdapter extends ListAdapter<AccountBalanceBosa, AccountBalanceBosaAdapter.FacilityViewHolder> {

    @NonNull
    private final Context mContext;
    private final Listener mListener;
    public AccountBalanceBosaAdapter(@NonNull Context context, Listener listener) {
    ...
    class FacilityViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(AccountBalanceBosa item) {
            ...
            itemAccountBalanceBinding.tvAmount.setText(String.format("%s %s", Constants.CURRENCY, item.getBalances()));
