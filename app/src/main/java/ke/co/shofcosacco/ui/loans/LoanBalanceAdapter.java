...
public class LoanBalanceAdapter extends ListAdapter<LoanBalance, LoanBalanceAdapter.FacilityViewHolder> {

    @NonNull
    private final Context mContext;
    private final Listener mListener;
    public LoanBalanceAdapter(@NonNull Context context, Listener listener) {
    ...
    class FacilityViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(LoanBalance item) {
            ...
            loanBalanceBinding.tvRepay.setText("View Statement");
