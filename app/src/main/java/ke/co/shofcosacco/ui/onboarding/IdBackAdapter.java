...
public class IdBackAdapter extends RecyclerView.Adapter<IdBackAdapter.PhotoViewHolder> {
    private Context context;
    private List<Bitmap> photoList;
    private OnRemoveClickListener onRemoveClickListener;

    public IdBackAdapter(Context context, List<Bitmap> photoList, OnRemoveClickListener onRemoveClickListener) {
