...
import static ke.co.shofcosacco.app.utils.Constants.RESET_PIN_TO_LOGIN;
...
import co.ke.shofcosacco.databinding.FragmentResetPinBinding;
import ke.co.shofcosacco.app.models.SecurityQuestion;
import ke.co.shofcosacco.app.navigation.BaseFragment;
import ke.co.shofcosacco.app.utils.RandomNumberGenerator;
...
public class ResetPinFragment extends BaseFragment {
    ...
    private FragmentResetPinBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding.tvRegister.setOnClickListener(v -> {
            ...
            int confirmNewPin = RandomNumberGenerator.generate4DigitNumber();
            ...
            if (code==null || code.trim().length()<binding.otp.getLength() || code.contains(" ")){
                ...
                textView.setText("Do you want to reset pin?");
                ...
                positiveButton.setOnClickListener(v4 -> {
                    ...
                    ProgressDialog progressDialog = ProgressDialog.show(getContext(), "",
                            "resetting pin. Please wait...", true);
                    authViewModel.resetPin(memberNo, String.valueOf(confirmNewPin),memberNo,code, questionCode, answer).observe(getViewLifecycleOwner(), apiResponse -> {
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RESET_PIN_TO_LOGIN && resultCode == Activity.RESULT_OK && data != null) {
            navigate(ResetPinFragmentDirections.actionResetPinToLogin());
